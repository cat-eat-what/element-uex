<template>
  <div class="elx-table-form">
    <div class="operate-button" v-if="config.unabledDeleteRowKeys != 'all'">
      <el-tooltip class="item" effect="dark" content="添加" placement="top">
        <span class="uex-icon-plus" @click="addData"></span>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="删除所有" placement="top">
        <span class="uex-icon-clear" @click="removeAllData"></span>
      </el-tooltip>
    </div>
    <elx-table
      ref="elxTable"
      ...
      <elx-table-column
        ...
        <template scope="scope">
          <el-tooltip
            ...
            placement="top">
            <span
              class="cus-color uex-icon-minus"
