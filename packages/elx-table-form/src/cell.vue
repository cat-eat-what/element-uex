<template>
  <div class="elx-table-form-cell" :class="isError ? 'error' : ''">
    <el-tooltip
      class="item"
      effect="light"
      placement="top"
      :content="String(cellText)">
      <span class="text" v-text="cellText"></span>
    </el-tooltip>
    <span class="uex-icon-warning" v-if="isError"></span>
    <div class="el-form-item__error" v-text="errorMsg"></div>
  </div>
</template>
<script>
