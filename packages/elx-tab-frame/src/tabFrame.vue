<template>
    <div class="elx-tab-frame">
        <elx-tabs type="border-card" v-model="currentActiveIndex" closable @edit="tabEdit" @tab-click="tabClick" @tab-add="addTab" @tab-remove="removeTab">
            <div class="title" slot="title">
                <span v-html="title"></span>
            </div>
            <el-tree :data="treeData" :props="defaultProps" @node-click="handleNodeClick"></el-tree>
            <el-tab-pane v-for="(item, index) in currentTabData" :key="item.name" :label="item.label" :name="item.name">
                <iframe :src="item.url" />
            </el-tab-pane>
        </elx-tabs>
    </div>
