<template>
  <div class="elx-card-form">
      ...
      <div class="form" v-for="(cardData, $index) in currentData" :key="$index">
        <elx-form v-model="currentData[$index]" :ref="'elxForm'+$index" :label-suffix="':'" :label-width="config.labelWidth" :config="config"></elx-form>
        <div class="operate">
