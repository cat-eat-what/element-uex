      ...
      <el-form-item
        ...
        <template v-if="field.type=='switch'" >
          <el-switch
            ...
            :on-text="'onText' in field ? field.onText : '是'"
            :off-text="'offText' in field ? field.offText : '否'"
            :on-value="'onValue' in field ? field.onValue : true"
            :off-value="'offValue' in field ? field.offValue : false"
            :on-color="'onColor' in field ? field.onColor : '#13ce66'"
            :off-color="'offColor' in field ? field.offColor : '#ff4949'"
            @change="'change' in field ? field.change(getSelf(), field, currentValue[field.name]) : ''">
          </el-switch>
        </template>
