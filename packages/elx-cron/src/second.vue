<template>
  <div class="elx-cron-second">
    <el-radio v-model="valType" label="1"><span>每秒 允许的通配符[, - * /]</span></el-radio>
    <el-radio v-model="valType" label="2">
      <span>周期从</span>
      <el-input-number size="small" v-model="valModel['2'].min" :min="1" :max="60"></el-input-number>
      <span>-</span>
      <el-input-number size="small" v-model="valModel['2'].max" :min="1" :max="60"></el-input-number>
      <span>秒</span>
    </el-radio>
    <el-radio v-model="valType" label="3">
      <span>从</span>
      <el-input-number size="small" v-model="valModel['3'].start" :min="0" :max="60"></el-input-number>
      <span>秒开始，每</span>
      <el-input-number size="small" v-model="valModel['3'].frequency" :min="1" :max="60"></el-input-number>
      <span>秒执行一次</span>
    </el-radio>
    <el-radio v-model="valType" label="4">
      <span>指定</span>
      <elx-checkbox-group v-model="valModel['4']">
