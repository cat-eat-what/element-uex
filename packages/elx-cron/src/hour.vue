<template>
  <div class="elx-cron-hour">
    ...
    <el-radio v-model="valType" label="3">
      <span>从</span>
      <el-input-number size="small" v-model="valModel['3'].start" :min="0" :max="24"></el-input-number>
      <span>小时开始，每</span>
      <el-input-number size="small" v-model="valModel['3'].frequency" :min="1" :max="100"></el-input-number>
      <span>小时执行一次</span>
    </el-radio>
