<template>
  <div class="elx-cron-year">
    <el-radio v-model="valType" label="1"><span>不指定 允许的通配符[, - * /]非必填</span></el-radio>
    <el-radio v-model="valType" label="2"><span>每年</span></el-radio>
    <el-radio v-model="valType" label="3">
      <span>周期从</span>
      <el-input-number size="small" v-model="valModel['3'].min" :min="1" :max="3000"></el-input-number>
      <span>-</span>
      <el-input-number size="small" v-model="valModel['3'].max" :min="1" :max="3000"></el-input-number>
      <span></span>
    </el-radio>
  </div>
</template>
