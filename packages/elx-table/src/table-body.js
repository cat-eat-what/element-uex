...
export default {
  ...
  mounted: function() {
    var self = this;
    this.addEvent(document.body, 'mouseup', this.handleDragUp);
    this.addEvent(document.body, 'mousemove', this.handleDragMove);
    this.addEvent(document.body, 'mouseleave', this.hhandleDragUp);
    this.addEvent(document.body, 'dragenter', this.handleDragEnter);
    this.addEvent(document.body, 'dragover', this.handleDragOver);
  ...
  methods: {
    ...
    createDropDomList: function(e) {
      ...
      if (dropData.length > 0) {
        ...
        this.addEvent(div, 'dragstart', function(e) {
