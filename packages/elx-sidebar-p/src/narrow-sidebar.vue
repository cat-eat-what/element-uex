<template>
  <el-tooltip class="item" effect="dark" :content="model.modelname" placement="right">
    <li @click.stop.prevent="menuChange" :class="liClass" >
        <a href="javascript:;">
            <span v-for="(item, index) in formatName" :key="index" >
