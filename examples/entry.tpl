...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../examples/assets/element-uex/style.css">
    <script src="../examples/assets/jquery/jquery.min.js"></script>
    <title>element-uex</title>
  </head>
  <body>
    <link rel="stylesheet" href="../examples/assets/styles/base.css">
    <link rel="stylesheet" href="../examples/assets/styles/layout.css">
