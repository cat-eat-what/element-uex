...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(109);
...
exports.default = {
  ...
  methods: {
    ...
    changePos: function changePos() {
      ...
      var height = this.$refs.elxContentMenu.clientHeight;
      var elBottom = height + Number(this.pos.y.split('px')[0]);
      ...
      return h(
        ...
        { 'class': nodeClass, on: {
            'dblclick': function dblclick($event) {
              return _this2.nodeDblClick(node, data, store, $event);
            },
            'contextmenu': function contextmenu($event) {
              return _this2.nodeClick(node, data, store, $event);
            }
          }
        },
        [this.line && level > 0 ? this._l(parentNodes, function (node, index) {
          ...
          [h('span', [!data.icon ? !node.isLeaf ? node.expanded ? h('span', { 'class': 'uex-icon-folder-open' }) : h('span', { 'class': 'uex-icon-folder' }) : h('span', { 'class': 'uex-icon-document' }) : h('span', { 'class': data.icon }), data.rename ? h('input', {
            ...
            on: {
              'blur': function blur() {
                return _this2.renameEmit(node);
              },
              'click': function click() {
                return _this2.changeRename(data);
              },
              'input': function input($event) {
                return _this2.changeLabel(data, $event);
              }
            },
            domProps: {
              'value': data.label
  ...
  watch: {
    ...
    contentMenuShow: function contentMenuShow(val) {
      var _this3 = this;
...
// CONCATENATED MODULE: ./packages/elx-tree/src/tree.vue?vue&type=template&id=37da7bc8&
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tree_vue_vue_type_template_id_37da7bc8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(225);
/* harmony import */ var _tree_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(108);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _tree_vue_vue_type_template_id_37da7bc8___WEBPACK_IMPORTED_MODULE_0__[/* render */ "a"],
  _tree_vue_vue_type_template_id_37da7bc8___WEBPACK_IMPORTED_MODULE_0__[/* staticRenderFns */ "b"],
  false,
  null,
  null,
  null
